...
export interface Asset {
  id: string; name: string; ticker: string; isin?: string; type: AssetType; shares: number; buyPrice: number; currentPrice: number; buyDate?: string; marketSymbol?: string; movements?: RoboMovement[]; threeDim?: ThreeDimensionClassification;
}
export interface RoboSubFund { id: string; isin?: string; name: string; weightPct: number }
export interface RoboAdvisor {
  id: string; name: string; entity: string; totalValue: number; investedValue: number; lastUpdated: string; subFunds?: RoboSubFund[]; threeDim?: ThreeDimensionClassification;
}
